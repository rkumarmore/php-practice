                                ...
                                <div class="card-body">
                                    <form action="{{route('register')}}" method='POST'>
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="name" value="{{old('name')}}" name="name" placeholder="Enter name here" required>
                                        @error('name')
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control" value="{{old('username')}}"  name="username" id="username" placeholder="Enter Username here" required>
                                            @error('username')
                                            <div class="alert alert-danger" role="alert">
                                                {{$message}}
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <input type="email" class="form-control" value="{{old('email')}}" name="email" id="email" placeholder="Enter Email here" required>
                                            @error('email')
                                            <div class="alert alert-danger" role="alert">
                                                {{$message}}
                                            </div>
