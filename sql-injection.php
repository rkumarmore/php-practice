...
<body>
	...
	<ul>
		...
		<li><p>The addslashes() function returns a string with backslashes in front of predefined characters.<br>
...
double quote (")<br>
backslash (\)<br>
NULL <br>	</p>This function can be used to prepare a string for storage in a database and database queries.</li>
	</ul>
</body>
</html>